...
console.log(Change_Position)
  ...
  return (
    <div onMouseMove={{Change_Position}} className="cont-2 h-[91vh] overflow-hidden font-pricedown">
      <div className="parent flex flex-col items-center">
        ...
        <img
          ...
          className="object-cover w-[500px] relative bottom-[100px] xl:bottom-[190px] xl:w-[600px] lg:bottom-[140px] lg:w-[540px] md:bottom-[110px] md:w-[540px] sm:bottom-[130px] sm:w-[600px]"
        />
        <img
